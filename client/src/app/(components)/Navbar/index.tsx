      ...
      <div className="flex justify-between items-center gap-5">
        <div className=" md:flex justify-between items-center gap-5">
          ...
          <div className="relative">
            ...
            <span className="absolute -top-2 -inset-0right-2 inline-flex items-center justify-center px-[0.4rem] py-1 text-xs font-semibold leading-none text-red-100 bg-red-400  rounded-full">
              3
            </span>
          </div>
        ...
        <div className="flex items-center gap-3 cursor-pointer">
          ...
          <span className="font-semibold">PR Kulkarni</span>
        </div>
        </div>
        <Link href='/setting'>
